...
- P7 pre-release hardening: added integration workflow tests (simulated/import/multi-sample), docs consistency checks, and CI smoke workflow.
- Added robust tutorial link fallbacks and a reproducible README figure regeneration script.
- Improved importer error messages for ambiguous spot IDs and missing numeric cell-type columns.
