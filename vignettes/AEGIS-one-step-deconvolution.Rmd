...
4. Use `plot_compare(type = "ranking")` as the primary ranking view and `render_report()` for the final output.
5. Use `run_aegis_full()` when you want the one-step execution wrapper plus downstream AEGIS analysis.
