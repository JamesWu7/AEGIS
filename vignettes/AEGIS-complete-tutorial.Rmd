---
title: "AEGIS Deconvolution from Scratch + Downstream Analysis (Human Lymph Node)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{AEGIS Deconvolution from Scratch + Downstream Analysis}
...
`get_supported_methods()` is the one place to inspect whether a method is:
- `run_and_import_r`
...
## Step 10. Visualization (plot_compare and related functions)
